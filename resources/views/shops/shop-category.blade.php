                ...
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb__text">
                        ...
                        <div class="breadcrumb__option">
                            ...
                            <span>{{$filterCategory->categorie}}</span>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="container">
                            ...
                            @endif
                                <div class="filter__found">
                                    <h6><span>{{count($filterProduct)}}</span> Produits trouvez</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        @forelse($filterProduct as $product)
                                ...
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        ...
                                        <div class="product__discount__item__text">
                                            ...
                                            <div class="product__item__price">€{{$promo->price}}<span></span></div>
                                        </div>
                                    </div>
                                </div>
                                @endif
