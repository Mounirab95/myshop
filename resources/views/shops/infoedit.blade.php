      ...
      <div class="row">
        ...
        <div class="col-xl-8 order-xl-1">
          <div class="card bg-secondary shadow">
            ...
            <div class="card-body">
              <form action="{{route('updater',$idUserInfo->id)}}" method="POST">
                @method('PATCH')
                @csrf
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group focused">
                        ...
                        <input type="text" id="input-first-name" name="name" class="form-control form-control-alternative" required value="{{$idUserInfo->name}}">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group focused">
                        <label class="form-control-label" for="input-last-name">Prénom</label>
                        <input type="text" id="input-last-name" name="familyname" class="form-control form-control-alternative" required value="{{$idUserInfo->familyname}}">
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group focused">
                        <label class="form-control-label" for="input-address">Télèphone</label>
                        <input type="number" id="input-address" name="tele" class="form-control form-control-alternative" required value="{{$idUserInfo->telephone}}" >
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group focused">
                        ...
                        <input id="input-address" class="form-control form-control-alternative" name="address" required value="{{$idUserInfo->address}}" type="text">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-4">
                      <div class="form-group focused">
                        ...
                        <input type="text" id="input-city" name="city" class="form-control form-control-alternative" required value="{{$idUserInfo->city}}" >
                      </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="form-group focused">
                        <label class="form-control-label" for="input-country">pays</label>
                        <input type="text" id="input-country" name="country" class="form-control form-control-alternative" required value="{{$idUserInfo->country}}" >
                      </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="form-group">
                        <label class="form-control-label" for="input-country">Code Postale</label>
                        <input type="number" id="input-postal-code" name="post" class="form-control form-control-alternative" required value="{{$idUserInfo->postale}}">
                      </div>
                    </div>
                  </div>
                </div>
                <hr class="my-4">
                <button class="btn btn-lg btn-default mr-4">Mise a jour</button>
              </form>
            </div>
          </div>
        </div>
